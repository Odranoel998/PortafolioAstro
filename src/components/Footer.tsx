...
export default function Footer() {
  ...
  return (
    <div className="mx-6 md:mx-10 py-3 md:py-4 z-20  grid place-items-center tracking-wide space-y-4 bg-[#009CA3] rounded-b-3xl shadow-2xl shadow-gray-400 mb-10">
      ...
      <div className="space-y-2 text-[15px] w-[180px] max-[330px]:ml-[-12%]">
